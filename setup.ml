...
(* OASIS_START *)
(* DO NOT EDIT (digest: bb3cb19e248350d9b48f70f9096d0df3) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("andotherdep", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files =
                        [("../_build/src/client/yourprogram.js", None)];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "yourprogram.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\207\164\164\n4.\241\245\024|\192A\202|\1339";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
